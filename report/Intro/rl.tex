...
Tic Tac Toe, the \comment{environment} is the current state of the game, 
...
Thus, when the agent chooses a place to drop the piece, it does so \comment{deterministically}
