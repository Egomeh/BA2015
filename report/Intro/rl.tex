...
trial and error. \comment{The environment typically consists of a set of states.
As an action, an agent can transition to another state.}
...
actions. \comment{To determine what action to take, the agent will use
...
\comment{The action transitions may 
