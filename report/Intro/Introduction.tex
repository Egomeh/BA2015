...
by comparing two state-of-the-art stochastic optimization algorithms search methods \comment{for ...}. 
...
the policies, \comment{conventional deterministic approaches} typically do not suffice 
