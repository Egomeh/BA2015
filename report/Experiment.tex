...
\comment{graphs to appendix + comment about the quantiles?}
...
\comment{write about intitial sigma}
...
For the initial experiments using CMA-ES, the only adjusted parameter is the initial 
...
From this, it's assumed that the initial step-size, at least in this range,
