...
Thus, the rate parameter of the distribution is given by
\footnote{Note that $\lambda$ is in this context not,
...
\begin{align*}
\frac{2\populationSize}{\chi^{2}_{1-\frac{\alpha}{2},2\populationSize}}
<
\frac{1}{\lambda}
< 
\frac{2\populationSize}{\chi^{2}_{\frac{\alpha}{2},2\populationSize}}
\end{align*}
