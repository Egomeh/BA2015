...
The agent chooses the action that leads from the current state 
...
\\
To verify this, the Tetris objective function was run using with the
...
by A. Boumaza, this will prevent CMA-ES from diverging step size,
and it can prevent loosing precision if the magnitude weight 
