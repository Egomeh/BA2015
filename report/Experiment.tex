...
score variates a lot for the different executions between a score of 300 and 6,000
rows. This results in an average score of 1,400$\pm36\%$ rows.\\
\textbf{Constant noise (figure \ref{fig:ceCnstantNoise})}: 
The 10 executions reaches equivalent performances at some point, with a score between
...
hereby verify that our implementation of CE works as intended.\\
...
\comment{Boxplot + graphs to appendix + comment about the quantiles?}
...
configuration technically performs better.
