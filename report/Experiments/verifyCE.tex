\subsection{Verification of our implementation of  Cross-entropy method \label{varifyofce}}

Because the \shark\ library already contains an implementation of 
CMA-ES, but not an implementation of 
\begin{changebar}
\cbcolor{blue}
...
hereby verify that our implementation of 
\begin{changebar}
\cbcolor{blue}
Cross-entropy method
\end{changebar}
works as intended. Even though the
