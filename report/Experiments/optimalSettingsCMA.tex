...
The experiments includes different games per agent of $\{1,3,5,7,10\}$. The reasoning for these specific 
values are discussed in section...\\
\comment{Write the CE section about gamers per agent and create a reference to it}
...
Setup of the "SUPER" experiment\\

\begin{figure}[H]
\centering
\begin{tabular}{c c c c}
Population & Parent size & Recombination & Games pr. Agent\\
\hline
...
\end{tabular}
\caption{Full experiments overview}
\end{figure}

\textbf{Results}\\
show results, specify best resuslts/candidates.\\
