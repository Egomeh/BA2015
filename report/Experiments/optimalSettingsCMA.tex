...
\comment{Argument for either green go black from the results section - this is the 
configuration for the comparison experiment}\\
\\
\comment{Result for best configuration is made using hard tetris, therefore it may not be the best result for Normal tetris.}
