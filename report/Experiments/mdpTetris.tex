...
\begin{changebar}
\cbcolor{blue}
Thus, as only the score seems to shift, but the relative performance between
the two algorithms remain, we use this harder Tetris as a valid means of reducing the
time consumption of the algorithms when experimenting with various parameters.
\end{changebar}
\\
...
\begin{changebar}
\cbcolor{blue}
This leads us to remain at
using the Bertsekas feature set as this keeps the time consumption of the
experiments lower.
\end{changebar}
