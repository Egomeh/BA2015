...
\comment{- Make an introduction of the parameters we can adjust}\\
\comment{- Make further experiments with 25\% selection size?}
...
\comment{Add the remaining two graphs with N = 100 to appendix}
...
\comment{- write about games per agent and dynamic games?}\\
\comment{- make experiment in the same style as the previous section , where we use the same pop/parent
size}
