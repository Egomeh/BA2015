...
In the implementation of CMA from \shark, 
...
The CMA itself manages setting $\offspringNumber$ and Cross-Entropy
is set according to the problem. Most papers that uses Cross-Entropy for Tetris
...
is another major factor in the runtime of the algorithm.
...
most papers report that the performance of the 
...
similar conditions as CMA, to ensure an unbiased 
comparison.
