...
state of the game. Using the method, the episode/game is simulated 
...
in our case, the final score. Thus, using this method, we do not need search 
...
All we have to be concerned with is to, on a trial-and-error basis
